  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await emailjs.send(
        "service_mg4ulkr", // Replace with your EmailJS service ID
        "template_yrv2rgh", // Replace with your EmailJS template ID
        {
        ...
        "9ka_TbrHNmAaORuf7" // Replace with your EmailJS public key
      );
    ...
    <>
      ...
      <div className="flex flex-wrap gap-4 xl:justify-between">
        <div className="mb-4 flex md:mb-0">
          ...
          >
            By clicking Checkbox, you agree to use our “Form” terms And consent
            to cookie usage in browser.
          </label>
        </div>
