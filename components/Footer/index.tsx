          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                ...
                <li>
  <a href="https://www.instagram.com/makexpo?igsh=MWZjY3oxbjNrMzgzcg==" target="_blank" aria-label="Instagram icon">
    <svg
      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
      width="24"
      height="24"
    ...
    >
      <g clipPath="url(#clip0)">
        <path
          d="M12 2.163c3.204 0 3.584.012 4.849.07 1.366.062 2.633.332 3.608 1.308.975.975 1.246 2.242 1.308 3.608.058 1.265.07 1.645.07 4.849s-.012 3.584-.07 4.849c-.062 1.366-.332 2.633-1.308 3.608-.975.975-2.242 1.246-3.608 1.308-1.265.058-1.645.07-4.849.07s-3.584-.012-4.849-.07c-1.366-.062-2.633-.332-3.608-1.308-.975-.975-1.246-2.242-1.308-3.608C2.175 15.647 2.163 15.267 2.163 12s.012-3.584.07-4.849c.062-1.366.332-2.633 1.308-3.608.975-.975 2.242-1.246 3.608-1.308C8.416 2.175 8.796 2.163 12 2.163zm0 1.837c-3.17 0-3.548.012-4.796.069-1.028.048-1.59.216-1.959.384-.479.206-.822.451-1.186.816-.364.364-.61.707-.816 1.186-.168.37-.336.931-.384 1.959-.057 1.248-.069 1.626-.069 4.796s.012 3.548.069 4.796c.048 1.028.216 1.59.384 1.959.206.479.451.822.816 1.186.364.364.707.61 1.186.816.37.168.931.336 1.959.384 1.248.057 1.626.069 4.796.069s3.548-.012 4.796-.069c1.028-.048 1.59-.216 1.959-.384.479-.206.822-.451 1.186-.816.364-.364.61-.707.816-1.186.168-.37.336-.931.384-1.959.057-1.248.069-1.626.069-4.796s-.012-3.548-.069-4.796c-.048-1.028-.216-1.59-.384-1.959-.206-.479-.451-.822-.816-1.186-.364-.364-.707-.61-1.186-.816-.37-.168-.931-.336-1.959-.384-1.248-.057-1.626-.069-4.796-.069zm0 4.34a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11zm0 1.837a3.662 3.662 0 1 0 0 7.325 3.662 3.662 0 0 0 0-7.325zm5.744-2.154a1.28 1.28 0 1 1 0 2.56 1.28 1.28 0 0 1 0-2.56z"
          fill=""
        />
      </g>
      <defs>
